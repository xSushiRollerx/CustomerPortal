...
class DropOffForm extends Component {
    ...
    render() {
        return (
            <div className='container-fluid' style={{ display: (this.props.showDropOffForm ? 'block' : 'none') }}>
                <div>
                    <div className='row'>
                            ...
                            <form>
                                <div className='form-group'>
                                    ...
                                    <input placeholder='Street Address' name='streetAddress' className='form-control'
                                         onChange={this.streetHandler}></input>
                                </div>
                                <div className='form-group'>
                                    <label>City:</label>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input placeholder='State' name='state' className='form-control'
                                         onChange={this.stateHandler} style={{ marginBottom: '10px' }}></input>
                                </div>
                                <div className='form-group'>
                                    <label>Zip Code: </label>
                                    <input placeholder='Zip Code' name='zipCode' className='form-control'
                                         onChange={this.zipCodeHandler} style={{ marginBottom: '10px' }}></input>
                                </div>
                                <div className='d-flex justify-content-center'>
                                    <button className='btn btn-secondary rounded-0' onClick={this.submitDeliveryAddress}
                                        >Submit</button>
